...
(cl:defmethod cl:initialize-instance :after ((m <add_two_ints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_ints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_topic-srv:<add_two_ints-request> is deprecated: use learning_topic-srv:add_two_ints-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <add_two_ints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_topic-srv:a-val is deprecated.  Use learning_topic-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <add_two_ints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_topic-srv:b-val is deprecated.  Use learning_topic-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_ints-request>)))
  ...
  "learning_topic/add_two_intsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_ints-request)))
  "Returns string type for a service object of type 'add_two_ints-request"
  "learning_topic/add_two_intsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <add_two_ints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add_two_ints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_topic-srv:<add_two_ints-response> is deprecated: use learning_topic-srv:add_two_ints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add_two_ints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_topic-srv:sum-val is deprecated.  Use learning_topic-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<add_two_ints-response>)))
  ...
  "learning_topic/add_two_intsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'add_two_ints-response)))
  "Returns string type for a service object of type 'add_two_ints-response"
  "learning_topic/add_two_intsResponse")
